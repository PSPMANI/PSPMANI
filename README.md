...
| [**JudgeLab - Judge Reliability Lab**](https://github.com/PSPMANI/judgelab) | Measures GPT-4-as-a-judge against 3,355 real MT-Bench human votes: kappa, position bias (15.8% order-swap flips), verbosity bias, per-category reliability. | Personal Project (2026) | Python, Streamlit, Statistics |
