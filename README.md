...
| **TrajLens - Trajectory Auditor** | 🌐 Public | Interactive agentic-trajectory auditor: steps through recorded tool-use traces and grades every turn against a 7-criterion binary rubric with deterministic verifiers, tagging failures across a named taxonomy and quantifying where an LLM-judge disagrees with human labels. Public synthetic data, no NDA content. | [🔗 Live](https://trajlens-mjh2vgfctsfyhrkulmtrxc.streamlit.app/) - [Code](https://github.com/PSPMANI/trajlens) |
...
| [**TrajLens - Trajectory Auditor**](https://github.com/PSPMANI/trajlens) - [🔗 Live](https://trajlens-mjh2vgfctsfyhrkulmtrxc.streamlit.app/) | Interactive agentic-trajectory auditor: grades agent tool-use traces against a 7-criterion binary rubric with deterministic verifiers, and quantifies where an LLM-judge disagrees with human labels. Public synthetic data. | Personal Project (2026) | Python, Streamlit, Verifiers |
